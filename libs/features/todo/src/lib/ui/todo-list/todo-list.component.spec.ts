...
describe('TodoListComponent', () => {
  ...
  it('should display the list or an empty text', () => {
    ...
    expect(fixture.debugElement.queryAll(By.directive(CardComponent)).length).toEqual(component.todoItems.length);

    component.todoItems = [];
    fixture.detectChanges();
    expect(fixture.debugElement.queryAll(By.directive(CardComponent)).length).toEqual(0);
    expect(fixture.debugElement.queryAll(By.css('[data-test-id="empty-text"]')).length).toEqual(1);
  });
});
